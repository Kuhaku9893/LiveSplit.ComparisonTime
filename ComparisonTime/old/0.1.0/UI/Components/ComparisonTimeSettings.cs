...
namespace LiveSplit.UI.Components
{
    public partial class ComparisonTimeSettings : UserControl
    {
        ...
        void RunPredictionSettings_Load(object sender, EventArgs e)
        {
            ...
            rdoTypeGoalTime.Checked = Type == TimeType.GoalTime;
        ...
        private void rdoTypeGoalTime_CheckedChanged(object sender, EventArgs e)
        {
            UpdateTimeType();
        }
        ...
        private int CreateSettingsNode(XmlDocument document, XmlElement parent)
        {
            ...
            string verSS = ver.Major.ToString() + "." + ver.Minor.ToString() + "." + ver.Build.ToString();

            return SettingsHelper.CreateSetting(document, parent, "Version", verSS) ^
